...
(function ($) {
    if ($.fn.ajaxForm == undefined) {
    	...
    	//alert(constantes.STRCONTEXTOAPLICACIONTOCOMPLETE+"/"+constantes.STRCARPETAJAVASCRIPT+"/jquery-ui-"+constantes.STRJQUERYVERSION+"/"+constantes.STRPLUGGIN+"/jquery.form.js");    	
    	//$.getScript(constantes.STRCONTEXTOAPLICACIONTOCOMPLETE+"/"+constantes.STRCARPETAJAVASCRIPT+"/jquery-ui-"+constantes.STRJQUERYVERSION+"/"+constantes.STRPLUGGIN+"/jquery.form.js");
    }
    var feature = {};
