/*****************************************************************
 Page : ricoLocale_de.js
 Description : localization strings for german
...
RicoTranslate.addPhraseId('sorting',"das Sortieren ist in Bewegung...");
...
RicoTranslate.addPhraseId('gridmenuHideShow',"Verbergen/Zeige");
...
RicoTranslate.addPhraseId('sessionExpireMinutes',"Minuten, bevor Ihre Sitzung abläuft");
...
RicoTranslate.addPhraseId('exportInProgress',"der Export ist in Bewegung...");
RicoTranslate.addPhraseId('showFilterRow',"zeigen Sie die Filterlinie");
RicoTranslate.addPhraseId('hideFilterRow',"Verbergen Sie die Filterlinie");
...
RicoTranslate.addPhraseId('deleting',"die Auslassung ist in Bewegung...");
RicoTranslate.addPhraseId('formPleaseEnter',"Bitte eingeben einen Wert für $1");
RicoTranslate.addPhraseId('formInvalidFmt',"unzulässiges Format an $1");
RicoTranslate.addPhraseId('formOutOfRange',"Wert ist aus Strecke heraus an $1");
RicoTranslate.addPhraseId('formNewValue',"neuer Wert:");
RicoTranslate.addPhraseId('saving',"einspeichernd...");
...
RicoTranslate.addPhraseId('editRecord',"Bearbeite Sie diese Eintragung");
RicoTranslate.addPhraseId('deleteRecord',"Löschen Sie diese Eintragung");
RicoTranslate.addPhraseId('cloneRecord',"Kopieren Sie diese Eintragung");
RicoTranslate.addPhraseId('addRecord',"Erstellen Sie eine neue Eintragung");
...
RicoTranslate.addPhraseId('treeSave',"Speichere Auswahl");
RicoTranslate.addPhraseId('treeClear',"löschen Sie alle");

// used in ricoCalendar.js

RicoTranslate.addPhraseId('calToday',"Heutiger Tag ist $1 $2 $3");
