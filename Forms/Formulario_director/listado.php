...
function countRec() {
                                 ...
                                 $sql = "SELECT count(cedula) FROM dato_personal";
...
$sql = "select iddatopersonal, cedula, nombres, apellidos, unidadoperativa, motivo, fechainicio, fechafin, horainicio, horafin, case autorizacion when 1 then 'Autorizado' when 0 then 'Rechazado' end as autorizacion from dato_personal $where";
...
foreach($rows AS $row){
	...
	$xml .= "<cell><![CDATA[".utf8_encode($row['motivo'])."]]></cell>";
