...
if($idperfil == '1'){
	...
	case autorizacion when 1 then 'Autorizado' when 0 then 'Rechazado' end as autorizacion,reemplazo from plan_vacaciones";
	...
	$sql = "select 	idplan_vacaciones, cedula, nombres, apellidos, fecha_1_salida, fecha_1_retorno,fecha_2_salida, fecha_2_retorno,fecha_3_salida, fecha_3_retorno,fecha_4_salida, fecha_4_retorno,fecha_5_salida, 
fecha_5_retorno,fecha_6_salida, fecha_6_retorno, 
case autorizacion when 1 then 'Autorizado' when 0 then 'Rechazado' end as autorizacion,reemplazo from plan_vacaciones where idpersonajefe = (select idpersona from persona where cedula = '".$cedula."')";
}
else{
	$sql = "select 	idplan_vacaciones, cedula, nombres, apellidos, fecha_1_salida, fecha_1_retorno,fecha_2_salida, fecha_2_retorno,fecha_3_salida, fecha_3_retorno,fecha_4_salida, fecha_4_retorno,fecha_5_salida, 
fecha_5_retorno,fecha_6_salida, fecha_6_retorno, 
