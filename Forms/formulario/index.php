...
$(".flexme3").flexigrid({
	...
	colModel : [ 
			...
			{display : 'fechainicio', name : 'fechainicio', width : 60, sortable : true, align : 'left'},
			{display : 'fechafin', name : 'fechafin', width : 60, sortable : true, align : 'left'},
			{display : 'horainicio', name : 'horainicio', width : 60, sortable : true, align : 'left'},
			{display : 'horafin', name : 'horafin', width : 60, sortable : true, align : 'left'}, 
...
function funciones(com, grid) {
	...
	if (com == 'Crear Formulario') {
				document.location.href = "../../formulario.php?action=insert";
	}
