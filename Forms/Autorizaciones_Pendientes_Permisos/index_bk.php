...
$(".flexme3").flexigrid({
	...
	colModel : [ 
			...
			{display : 'Nombres', name : 'nombres', width : 100, sortable : true, align : 'left'}, 
			{display : 'Apellidos', name : 'apellidos', width : 100, sortable : true, align : 'left'},
		//	{display : 'Direccion/Unidad', name : 'unidadoperativa', width : 150, sortable : true, align : 'left'},
		//	{display : 'Motivo', name : 'motivo', width : 130, sortable : true, align : 'left'},
			{display : 'Motivo', name : 'valor', width : 130, sortable : true, align : 'left'},
			{display : 'Fecha_Inicio', name : 'fechainicio', width : 65, sortable : true, align : 'left'},
			{display : 'Fecha_Fin', name : 'fechafin', width : 65, sortable : true, align : 'left'},
			{display : 'Hora_Inicio', name : 'horainicio', width : 65, sortable : true, align : 'left'},
			{display : 'Hora_Fin', name : 'horafin', width : 65, sortable : true, align : 'left'}, 
			{display : 'Observación', name : 'observaciones', width : 150, sortable : true, align : 'left'},
...
function exportarExcell(com, grid) {
	...
	if (com == 'Exportar') {
		     $.ajax({  
                 ...
                 url: "BusquedaGeneralExcel.php",  
                 //data: data, 
				 //data:'cedula='+'1716894702'+'&idperfil='+'3',
				// data:'cedula='+cedula+'&idperfil='+idperfil,
