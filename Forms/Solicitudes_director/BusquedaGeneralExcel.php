...
$limit = "LIMIT $start, $rp";
	...
	$sql = "select 	idsolicitud, cedula, nombres, apellidos, unidadoperativa, fecha_inicio, fecha_fin, case autorizacion when 1 then 'Autorizado' when 0 then 'Rechazado' end as autorizacion,reemplazo from solicitud_vacaciones where cedula = '".$cedula."'";
...
$result = query($sql);
		...
		while($row = mysql_fetch_array($result))
		  {	
		  	...
		  	$unidadoperativa = utf8_encode($row['unidadoperativa']);
