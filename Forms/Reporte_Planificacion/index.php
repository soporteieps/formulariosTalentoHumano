<?php
  ...
  $tipo = $_GET['tipo'];
  //echo "idperfil=".$_SESSION["idperfil"].", tipo=",$tipo."<br>";
  //$_SESSION["tipo"] = $_GET['tipo'];
...
<head>
    ...
    <title>REPORTE PLANIFICACION DE VACACIONES</title>
  ...
  if(($idperfil == '1' || $idperfil == '3' || $idperfil == '4') && $tipo == 'general'){
     ...
     <div>
	    ...
	    <tr>
		    ...
		    <td><font size="1" face="Arial, Helvetica, sans-serif"><input type="text" id="cedula" name="cedula" maxlength="10"></input></font></td>   		   		   	 <?php 
				if(($idperfil == '1' || $idperfil == '4')    && $tipo == 'general'){			
			?>		
   			<td width="130"><span class="style2"><em><strong><font color="#003399" size="2" face="Arial, Helvetica, sans-serif">*Direccion/Unidad:</font></strong></em></td>
...
$(".flexme3").flexigrid({
	...
	dataType : 'xml',
	colModel : [ 
			{display : 'Id', name : 'idplan_vacaciones', width : 80, sortable : true, align : 'left'},
	...
	sortname : "cedula,apellidos",
	sortorder : "asc",
	usepager : true,
	title : 'REPORTE PLANIFICACION DE VACACIONES',
	useRp : false,
	rp : 100,
