...
$(".flexme3").flexigrid({
	...
	dataType : 'xml',
	colModel : [ 
			{display : 'Id', name : 'iddatopersonal', width : 80, sortable : true, align : 'left'},
			...
			{display : 'fechainicio', name : 'fechainicio', width : 75, sortable : true, align : 'left'},
			{display : 'fechafin', name : 'fechafin', width : 75, sortable : true, align : 'left'},
			{display : 'horainicio', name : 'horainicio', width : 75, sortable : true, align : 'left'},
			{display : 'horafin', name : 'horafin', width : 75, sortable : true, align : 'left'},
			{display : 'motivo', name : 'motivo', width : 75, sortable : true, align : 'left'}, 
