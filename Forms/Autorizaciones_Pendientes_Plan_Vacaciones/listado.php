...
function countRec($where) {
                                 ...
                                 $sql = "SELECT count(cedula) FROM plan_vacaciones $where";
...
$sql = "select idplan_vacaciones, cedula, nombres, apellidos,case autorizacion when 1 then 'Autorizado' when 0 then 'Rechazado' end as autorizacion,reemplazo, comentario from plan_vacaciones $where";
...
//	$xml .= "<cell><![CDATA[".utf8_encode($row['comentario'])."]]></cell>";
